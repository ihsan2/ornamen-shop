      ...
      <View>
        ...
        <View style={styles.detail}>
          <Label bold size={24} color={'#113764'} mb={12}>
            {item?.detail?.name} - {item?.detail?.storeName}
          </Label>
          ...
          {item?.tipe == 'antar' && (
            <View>
              ...
              <Label bold size={16} mb={8} color={'#000'}>
    ...
    <SafeAreaView style={styles.scrollContainer}>
      <ScrollView>
        ...
        <View style={styles.container}>
          ...
          {item?.email === user?.email && item?.status == '0' && (
            <Button
              onPress={() => navigation.navigate('Proof', {item})}
              label={'Kirim Bukti Transfer'}
              primary={'#52C41A'}
              border={'#52C41A'}
              style={{marginHorizontal: 20, marginTop: 20, marginBottom: 36}}
            />
          )}
        </View>
      </ScrollView>
